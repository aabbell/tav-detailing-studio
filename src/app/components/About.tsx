      ...
      <div className="py-35 px-10 grid md:grid-cols-2 gap-12 items-center">
        <div className="">
          <h1 className="text-5xl font-bold leading-tight mb-6">
            Your Car <br /> Deserves <br />
            <span className="text-blue-600">The Best Shine</span>
          </h1>
          <p className="text-lg text-gray-800 mb-8">
            Professional car wash services that come to you. Book in minutes get
            your car sparing clean.
          </p>
